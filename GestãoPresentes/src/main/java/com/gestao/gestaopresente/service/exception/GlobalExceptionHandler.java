package com.gestao.gestaopresente.service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Response<Object>> handleExpiredJwt(ExpiredJwtException ex) {
        var response = new Response<>(ex.getMessage(), HttpStatus.UNAUTHORIZED.value());
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(response);
    }
}
