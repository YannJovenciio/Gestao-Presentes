...
public class PresenteServiceImpl implements IPresenteService {
    ...
    public PresenteServiceImpl(
            PresenteRepository presenteRepository, ServidorRepository servidorRepository) {
                        ...
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                "Entidade não encontrada para o id fornecido"));
        return new PresenteResponse(
                presente.getId(),
                presente.getPaisId(),
                presente.getDataEntrega(),
                presente.getObservacao(),
                presente.getValor());
    }
    ...
    public PresenteResponse create(PresenteInput input, String servidorEmail) {
        ...
        var presente =
                new Presente(servidor, input.dataEntrega(), input.observacao(), input.valor());
