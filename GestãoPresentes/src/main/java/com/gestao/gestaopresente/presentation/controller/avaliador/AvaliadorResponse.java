...
public record AvaliadorResponse(Long id, String nome, Sexo sexo, String endereco, String telefone, String email,
                                @JsonProperty(required = false) List<Presente> presentes) {

    public AvaliadorResponse(Long id, String nome, Sexo sexo, String endereco, String telefone, String email) {
