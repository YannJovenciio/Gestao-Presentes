...
import com.gestao.gestaopresente.service.servidor.UpdateServidorDto;
...
public class ServidorController {
    ...
    @PostMapping
    public ResponseEntity<Response<ServidorResponse>> create(@RequestBody @Valid ServidorInput input) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Response<ServidorResponse>> update(@RequestBody UpdateServidorDto updateServidorDto, @PathVariable Long id) {
        var response = servidorService.update(updateServidorDto, id);
